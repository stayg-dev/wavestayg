  ...
  return (
    ...
    >
      ...
      <section className="portal-card" aria-label="수분양자 베네핏 규정">
        ...
        <p>② 비수기: 입실 14일 전 예약 필수 / 1일 1회, 2실·3박 연속까지.</p>
        <p>③ 성수기(7~8월): 세대당 연 1회, 최대 3박(1실). [연도별세대혜택] 시트에서 자동 잠금.</p>
        <p>④ 상위 타입 업그레이드: (상위판매가 − 소유판매가) × 50%를 추가 요금으로 부과.</p>
        <p>⑤ 취소 규정: 7일 전 무료 / 3일 전 50% 차감(홀수 내림) / 당일·노쇼 100% 차감.</p>
        <p>⑥ 이월: 익년 3/31까지 사용, 잔여 × 50%(홀수 내림). 3/31 초과 시 자동 소멸.</p>
        <p>⑦ 2026년(첫해)은 9/1 개시로 5박 비례 부여, 2026-12-31 전량 자동 소멸(이월 없음).</p>
      </section>
